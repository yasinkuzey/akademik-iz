        ...
        <div className="rounded-xl border border-border bg-card p-8 shadow-lg">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full py-2.5 rounded-lg border border-border bg-background text-foreground font-semibold shadow-sm hover:bg-accent/5 transition-all flex items-center justify-center gap-2"
            >
