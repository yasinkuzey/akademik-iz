        ...
        <div className="rounded-xl border border-border bg-card p-8 shadow-lg">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-[rgb(var(--secondary))] text-[rgb(var(--secondary-fg))] font-bold shadow-md hover:brightness-95 hover:shadow-lg transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed group"
            >
